...
const getDOMNodes = function(data) {
  ...
  return {
    ...
    configurationFormManual:
      component.refs.configurationFormManual && component.refs.configurationFormManual.getDOMNode(),
    configurationFormUrl:
      component.refs.configurationFormUrl && component.refs.configurationFormUrl.getDOMNode(),
    configurationFormXml:
      component.refs.configurationFormXml && component.refs.configurationFormXml.getDOMNode(),
    configurationFormLti2:
      component.refs.configurationFormLti2 && component.refs.configurationFormLti2.getDOMNode(),
    configurationTypeSelector:
      component.refs.configurationTypeSelector &&
      component.refs.configurationTypeSelector.getDOMNode(),
    submitLti2: component.refs.submitLti2 && component.refs.submitLti2.getDOMNode(),
    submit: component.refs.submit && component.refs.submit.getDOMNode()
  }
}
