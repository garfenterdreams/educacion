...
describe "eportfolios" do
  ...
  context "eportfolio created with user" do
    ...
    it "should reorder a page", priority: "1", test_id: 3011033, ignore_js_errors: true do
      get "/eportfolios/#{@eportfolio.id}"
    ...
    it "should reorder a section", priority: "1", test_id: 3011036, ignore_js_errors: true do
      get "/eportfolios/#{@eportfolio.id}"
