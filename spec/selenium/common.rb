...
require File.expand_path(File.dirname(__FILE__) + '/helpers/selenium_test_helper_methods')
...
shared_examples_for "all selenium tests" do
  ...
  def login_as(username = "nobody@example.com", ***REMOVED***, expect_success = true)
