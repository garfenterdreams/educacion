...
shared_examples_for "course selenium tests" do
  ...
  it "should allow moving a student to a different section" do
    ...
    ***REMOVED***
    ...
    observer = user :active_user => true
    oe = c.enroll_student(observer)
    ...
    def move_section_for_enrollment(enrollment, section)
      student_user = driver.find_element(:css, ".user_list #enrollment_#{enrollment.id}")
    ...
    move_section_for_enrollment(se, section)
    move_section_for_enrollment(oe, section)
  end
end
