...
describe "users" do
  ...
  context "admin merge" do
    ...
    before do
      ...
      @student_1.register!
      @student_1.pseudonyms.create!(unique_id: @student_1_id, ***REMOVED***, password_confirmation: "asdfasdf")
      @course.enroll_user(@student_1).accept!

      @student_2 = User.create!(name: "Student Two")
      @student_2.register!
      @student_2.pseudonyms.create!(unique_id: @student_2_id, ***REMOVED***, password_confirmation: "asdfasdf")
