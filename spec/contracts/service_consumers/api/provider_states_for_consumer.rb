  ...
  class BaseState
    ...
    def seed_account_admins(count: 1)
      ...
      count.times do |i|
        ...
        admin.pseudonyms.create!(unique_id: admin_email, ***REMOVED***, password_confirmation: 'password')
    ...
    def seed_teachers(count: 1)
      ...
      count.times do |i|
        ...
        teacher.pseudonyms.create!(unique_id: teacher_email, ***REMOVED***, password_confirmation: 'password')
    ...
    def seed_teacher_assistants(count: 1)
      ...
      count.times do |i|
        ...
        ta.pseudonyms.create!(unique_id: ta_email, ***REMOVED***, password_confirmation: 'password')
        ta.email = ta_email
        ta.accept_terms
    ...
    def seed_students(count: 1)
      ...
      count.times do |i|
        ...
        student.pseudonyms.create!(unique_id: student_email, ***REMOVED***, password_confirmation: 'password')
    ...
    def seed_observers(count: 1)
      ...
      count.times do |i|
        ...
        observer.pseudonyms.create!(unique_id: observer_email, ***REMOVED***, password_confirmation: 'password')
